...
import { UserOutlined, LogoutOutlined, ShoppingCartOutlined, ShoppingOutlined } from '@ant-design/icons';
                                        ...
                                        <div className={cx('info')}>
                                            ...
                                            <p>
                                                {item.priceDiscount > 0
                                                    ? item.priceDiscount.toLocaleString('vi-VN') + 'đ'
                    ...
                    <div className={cx('user-menu')}>
                        <div className={cx('cart-menu')}>
                            <Link to="/cart" className={cx('cart-button')}>
                                ...
                                Giỏ hàng ({dataCart?.newData?.data?.length || 0})
                            </Link>
                        </div>
                        <Dropdown
                            overlay={
