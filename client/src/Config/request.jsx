...
export const requestVerifyAccount = async (data) => {
    const res = await request.post('/api/verify-account', data);
    return res.data;
};

export const requestResendOtp = async (data) => {
    const res = await request.post('/api/resend-otp', data);
    return res.data;
};
